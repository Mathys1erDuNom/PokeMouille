...
INPUT_FILE  = os.path.join(root_dir, "json", "new_pokemons", "pokemon_gen5_normal.json")
OUTPUT_FILE = os.path.join(root_dir, "json", "new_pokemons", "pokemon_gen5_shiny.json")
# ──────────────────────────────────────────────────────────────────────────────
