...
INPUT_FILE  = os.path.join(root_dir, "json", "new_pokemons", "pokemon_gen3_normal.json")
OUTPUT_FILE = os.path.join(root_dir, "json", "new_pokemons", "pokemon_gen3_shiny.json")
# ──────────────────────────────────────────────────────────────────────────────
